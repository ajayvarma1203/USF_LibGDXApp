...
public class SignupScreen implements Screen {
    ...
    private Stage stage;
    private TextField userName, password, confirmPassword, date, month, year;
    private TextButton createAccount;

    public SignupScreen(BullsEye bullsEye) {
        parent = bullsEye;
    ...
    public void show() {
        ...
        month.setTextFieldFilter(new TextField.TextFieldFilter.DigitsOnlyFilter());
        year.setMaxLength(4);
        createAccount = new TextButton("Create Account!", skin);
        ...
        table.row().pad(40, 0, 40, 0);
        table.add(createAccount).colspan(3);
        table.row().pad(40, 0, 40, 0);
